...
module confreg(
    ...
    always @ (posedge clk) begin
        if (rst == `RST_ENABLE) begin
            ...
            case(confreg_addr[15:0])
                ...
                `SWITCH_ADDR        : conf_rdata_reg = switch_v;
                `LED_ADDR           : conf_rdata_reg = {24'b0, led_v};
                `MID_BTN_KEY_ADDR   : conf_rdata_reg = mid_btn_key_v;
                `LEFT_BTN_KEY_ADDR  : conf_rdata_reg = left_btn_key_v;
                `RIGHT_BTN_KEY_ADDR : conf_rdata_reg = right_btn_key_v;
                `UP_BTN_KEY_ADDR    : conf_rdata_reg = up_btn_key_v;
                `DOWN_BTN_KEY_ADDR  : conf_rdata_reg = down_btn_key_v;
    ...
    assign led = led_v;
    wire write_led;
    assign write_led = conf_we & (confreg_addr[15:0] == `LED_ADDR);
